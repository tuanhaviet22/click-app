...
<!--              <div class="image-intro" v-for="image in media_data" v-if="image.image">-->
<!--                <img :src="image.image" :alt="image.alt" :title="image.title">-->
<!--              </div>-->
<!--            </div>-->
<!--            <div v-else v-if="media_data.video_avatar != null">-->
<!--              <img loading="true" :src="media_data.video_avatar" class="w-100 d-block gallery-thumb"-->
<!--                   :alt="media_data.module_title"-->
<!--                   :title="media_data.module_title">-->
<!--              <a class="btn-play-video fancybox-media absolute" rel="fancybox-media" :href="media_data.video">-->
<!--                <i class="fa fa-play"></i>-->
<!--              </a>-->
<!--            </div>-->

<!--            <div v-else v-html="media_data.video"></div>-->
<!--          </div>-->
<!--        </div>-->
<!--        <div class="col-right">-->
...
<!--                    :options="settings"-->
<!--            >-->
<!--              <swiper-slide v-for="image in media_data">-->
<!--                <div class="image-intro" v-if="image.image">-->
<!--                  <img :src="image.image" :alt="image.alt" :title="image.title">-->
<!--                </div>-->
<!--              </swiper-slide>-->
<!--            </swiper>-->
<!--            <div v-else v-if="media_data.video_avatar != null">-->
<!--              <img v-if="media_data.video_avatar" loading="true" :src="media_data.video_avatar"-->
...
<!--              </a>-->
<!--            </div>-->
<!--            <div v-else v-html="media_data.video">-->
<!--            </div>-->
<!--          </div>-->
...
export default {
  ...
  async fetch() {
    ...
    if (this.metadata.media_type  == 'image') {
      this.media_data = JSON.parse(this.metadata['image'])
    } else if (this.metadata.media_type == 'video') {
      this.media_data = JSON.parse(this.metadata['media_data'])
    }
  }
}
</script>
